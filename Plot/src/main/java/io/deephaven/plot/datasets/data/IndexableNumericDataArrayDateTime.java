...
/**
 * {@link IndexableNumericData} dataset comprised of an array of {@link Instant}s.
 *
...
public class IndexableNumericDataArrayDateTime extends IndexableNumericData {
     ...
     */
    public IndexableNumericDataArrayDateTime(Instant[] data, final PlotInfo plotInfo) {
        super(plotInfo);
