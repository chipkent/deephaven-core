...
public class PlotUtils {
    ...
    private static final Instant[] EMPTY_DATETIME_ARRAY = new Instant[0];
    ...
    public static Function<Long, Number> getNumberFromNumericOrTimeSource(final Table t, final String numericCol,
        ...
        if (columnSource.getType() == Instant.class) {
            return key -> {
                final Instant dateTime = (Instant) columnSource.get(key);
                return dateTime == null ? NULL_LONG : DateTimeUtils.epochNanos(dateTime);
            };
    ...
    public static IndexableNumericData createIndexableNumericDataArray(final Object data, final Class dataType,
        ...
        if (dataType == int.class) {
            ...
            if (data instanceof long[]) {
                ...
                return new IndexableNumericDataArrayDateTime((Instant[]) data, plotInfo);
            }
        } else if (dataType == Date.class) {
