...
public class JdbcToTableAdapterTest {
    ...
    public void testDefaultResultTypes() throws SQLException {
        ...
        final ColumnSource<Instant> datetime_type = result.getColumnSource("datetime_type");
        ...
        Assert.assertEquals(Instant.class, datetime_type.getType());
        ...
        for (long ii = 0; ii < result.size(); ++ii) {
            ...
            if (ii % 256 == 6) {
                ...
                final Instant dt = datetime_type.get(ii);
                // is only accurate
