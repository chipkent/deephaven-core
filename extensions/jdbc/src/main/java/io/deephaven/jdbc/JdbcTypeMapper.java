...
public class JdbcTypeMapper {
     ...
     * LocalDate or a Instant for example. And the same is true for the target type - a Instant might be sourced from
     ...
     * order to be converted to an Instant properly. Writing a Instant to a JDBC datasource (via the bind mechanism)
    ...
    public static class DateDateTimeDataTypeMapping extends DataTypeMapping<Instant> {
    ...
    public static class TimestampDateTimeDataTypeMapping extends DataTypeMapping<Instant> {
        ...
        public void bindToChunk(
            ...
            objectChunk.set(destOffset, timestamp == null ? null
                    : DateTimeUtils.epochNanosToInstant(timestamp.getTime() * MILLIS_TO_NANOS + timestamp.getNanos() % 1_000_000));
        }
    ...
    static {
        ...
        dataTypeMappings = Map.ofEntries(
                ...
                Map.entry(Types.DATE, MappingCollection.builder(LocalDate.class)
                        ...
                        .mapping(Instant.class, new DateDateTimeDataTypeMapping())
                ...
                Map.entry(Types.TIMESTAMP, MappingCollection.builder(Instant.class)
                        .mapping(Instant.class, new TimestampDateTimeDataTypeMapping(Types.TIMESTAMP))
                ...
                Map.entry(Types.TIMESTAMP_WITH_TIMEZONE, MappingCollection.builder(Instant.class)
                        .mapping(Instant.class, new TimestampDateTimeDataTypeMapping(Types.TIMESTAMP_WITH_TIMEZONE))
    ...
    static {
        ...
        try {
            ...
            sqlServerMap.put(SqlServerTypes.DATETIMEOFFSET, MappingCollection.builder(Instant.class)
                    .mapping(Instant.class, new TimestampDateTimeDataTypeMapping(SqlServerTypes.DATETIMEOFFSET))
                    .build());
