...
public class JsonNodeUtil {
    ...
    /**
     * Returns a {@link Instant} from a {@link JsonNode}. Will try to infer precision of a long value to be parsed
     ...
     */
    @Nullable
    public static Instant getDateTime(@NotNull final JsonNode node, @NotNull final String key,
            final boolean allowMissingKeys, final boolean allowNullValues) {
        final JsonNode tmpNode = checkAllowMissingOrNull(node, key, allowMissingKeys, allowNullValues);
     ...
     */
    @Nullable
    public static Instant getDateTime(@NotNull final JsonNode node, @NotNull final JsonPointer ptr,
            final boolean allowMissingKeys, final boolean allowNullValues) {
        final JsonNode tmpNode = checkAllowMissingOrNull(node, ptr, allowMissingKeys, allowNullValues);
        return getDateTime(tmpNode);
    }
     ...
     */
    @Nullable
    public static Instant getDateTime(final JsonNode node) {
        if (isNullOrMissingField(node)) {
            return null;
        }
