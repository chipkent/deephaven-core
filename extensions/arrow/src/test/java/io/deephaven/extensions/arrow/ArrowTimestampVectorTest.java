...
public class ArrowTimestampVectorTest {
    ...
    private static final Instant[] expectedValues = new Instant[] {DateTimeUtils.epochNanosToInstant(1670443801), DateTimeUtils.epochNanosToInstant(1570443532), null, DateTimeUtils.epochNanosToInstant(0), DateTimeUtils.epochNanosToInstant(170443801), DateTimeUtils.epochNanosToInstant(-72309740)};
